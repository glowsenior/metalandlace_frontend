...
const FeaturedCategories = () => {
  const categories = [
    { name: "Tumblers", image: "https://images.unsplash.com/photo-1578749556568-bc2c40e68b61?q=80&w=2876&auto=format&fit=crop", link: "/products?category=Tumblers" },
    { name: "Ceramics", image: "https://plus.unsplash.com/premium_photo-1673329319294-cb70fb0cba60?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDU5fHx8ZW58MHx8fHx8", link: "/products?category=Ceramics" },
